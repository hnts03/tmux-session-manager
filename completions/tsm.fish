...
set -l subcommands new ls kill rename config save restore log template clone group claude cc doctor version help
...
complete -c tsm -n "not __fish_seen_subcommand_from $subcommands" -a claude   -d "Monitor Claude Code sessions per pane"
complete -c tsm -n "not __fish_seen_subcommand_from $subcommands" -a cc       -d "Alias for claude"

# claude / cc: options
complete -c tsm -n "__fish_seen_subcommand_from claude cc" -l status        -d "Show Claude Code state per pane"
complete -c tsm -n "__fish_seen_subcommand_from claude cc" -l install-hooks -d "Install reporting hooks (planned)"
...
complete -c tsm -n "__fish_seen_subcommand_from log; and __fish_seen_subcommand_from start" -l all          -d "All panes in current session"
complete -c tsm -n "__fish_seen_subcommand_from log; and __fish_seen_subcommand_from start" -l all-sessions -d "All panes across all sessions (skip already-logging)"
complete -c tsm -n "__fish_seen_subcommand_from log; and __fish_seen_subcommand_from stop"  -l all          -d "All panes in current session"
complete -c tsm -n "__fish_seen_subcommand_from log; and __fish_seen_subcommand_from stop"  -l all-sessions -d "All logged panes across all sessions"
